...
class SendTransaction extends _events.default {
  ...
  constructor({
    ...
    this.pin = pin;
    this.network = network; // Error to be shown in case of an unexpected error when executing push tx
  ...
  prepareTx() {
    ...
    try {
      preparedData = _transaction.default.prepareData(fullTxData, this.pin);
