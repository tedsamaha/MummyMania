...
const transaction = {
  ...
  validateAddress(address, addressBytes) {
    ...
    if (firstByte !== _network.default.getVersionBytes().p2pkh && firstByte !== _network.default.getVersionBytes().p2sh) {
      throw new _errors.AddressError(errorMessage);
    }
  ...
  outputValueToBytes(value) {
    ...
    if (value > _constants.MAX_OUTPUT_VALUE) {
      throw new _errors.OutputValueError(`Maximum value is ${_helpers.default.prettyValue(_constants.MAX_OUTPUT_VALUE)}`);
    }
